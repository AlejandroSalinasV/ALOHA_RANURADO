...
simulado = []
teorico = []
for N_i in range(len(N_arreglo)):
    
    N = N_arreglo[N_i]# NUMERO DE USUARIOS
    lmda = 5 # paquetes /s
...
plt.plot(N_arreglo, simulado, 'bo-', label='Tasa de paquetes simulado')
plt.plot(N_arreglo, teorico, 'r--', label='Tasa de paquetes teorica')
